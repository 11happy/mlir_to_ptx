module attributes {gpu.container_module} {
  func.func @vecadd(%arg0: memref<256x256xf16>, %arg1: memref<256x256xf16>, %arg2: memref<256x256xf16>) {
    ...
    gpu.launch_func  @vecadd_kernel::@vecadd_kernel blocks in (%c256, %c1, %c1) threads in (%c256, %c1, %c1)  args(%c0 : index, %c0 : index, %arg0 : memref<256x256xf16>, %arg1 : memref<256x256xf16>, %arg2 : memref<256x256xf16>)
    return
  }
